...
/** Ответ эндпоинта рекомендаций обмена (многохоповый маршрут). */
export type TProductRecommendationsResponse = {
    /** Товары цепочки обмена: вверху — желанный, внизу — товар пользователя. */
    Products: TProduct[];
