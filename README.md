...
<h1>Зона ответственности каждого члена команды</h1>
<div>
<h3>Нгуен Туан Минь</h3>
<ul>
  <li>Отвечал за разработку архитектуры проекта с нуля (Каркас)</li>
  <li>Отвечал за разработку БД с нуля и доведения его до корректности связей</li>
  <li>Отвечал за создания схем пользовательских сценарий в БД (Основной сценарий)</li>
  <li>Отвечал за разработку авторизации в проекте</li>
</div>
