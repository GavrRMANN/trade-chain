...
CREATE INDEX idx_chains_from_product_id ON chains(from_product_id);
CREATE INDEX idx_chains_to_product_id ON chains(to_product_id);
CREATE INDEX idx_chains_status ON chains(status);
CREATE INDEX idx_reviews_to_customer_id ON reviews(to_customer_id);
CREATE INDEX idx_reviews_from_customer_id ON reviews(from_customer_id);
